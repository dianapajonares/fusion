...
import HbA1cDrawerContent from "../components/HbA1cDrawerContent";
...
import TreatmentDrawerContent from "../components/TreatmentDrawerContent";
import {
  PatientIcon,
  ExpandMoreIcon,
  GlucoseIcon,
...
function PatientDashboard() {
  ...
  const {
    ...
    savePrefs,
  } = useDashboardPreferences(pacienteId);
  ...
  const [showHbA1cDrawer, setShowHbA1cDrawer] = useState(false);
  ...
  const activeCardsTop = [prefs.glucosa || prefs.eventos, prefs.hba1c].filter(
    Boolean
  ).length;
  ...
  const totalBottomCards = prefs.glucosa
    ? bottomCardsCount
    : bottomCardsCount + activeCardsTop;
  ...
  useEffect(() => {
    ...
    loadHistory();
  }, [pacienteId, showHbA1cDrawer]);

  const reloadManualEvents = async () => {
    try {
      const [manualRes, patientRes] = await Promise.all([
        fetch(
          `http://127.0.0.1:8000/api/v1/manual-events/paciente/${pacienteId}`,
          {
            credentials: "include",
  ...
  if (avgGlucose && seriesValues.length > 0) {
    const variance =
      seriesValues.reduce(
        (acc, val) => acc + Math.pow(val - avgGlucose, 2),
        0
      ) / seriesValues.length;
  ...
  const avgReadingsPerDay =
    PERIOD_DAYS > 0 ? (totalReadings / PERIOD_DAYS).toFixed(0) : 0;
  ...
  return (
    <div className="app-root">
      ...
      <main className="dashboard-main">
        <header className="dashboard-header" ref={patientHeaderRef}>
          <div className="patient-header-group">
            ...
            >
              ...
              <div className="patient-chip-text">
                ...
                <span className="patient-chip-period">Paciente</span>
              </div>
          ...
          <div className="period-navigation">
            <div className="period-box">
              <button onClick={() => movePeriod(-1)} className="period-arrow">
                ‹
              </button>
              ...
              <div className="period-center">
                <span className="period-text">
                  ...
                  {formatRangeDate(getEndDate(startDate))}
                </span>
          ...
          <button
            ...
            onClick={() => setShowHbA1cDrawer(true)}
        ...
        {showPatientInfo &&
          (() => {
            ...
            const rawDiseases =
              ...
              "Diabetes tipo 1 desde los 12 años. Hipotiroidismo autoinmune.";
            const diseaseList = rawDiseases
              .split(".")
              .map((d) => d.trim())
              .filter((d) => d.length > 0);
                ...
                <div className="epp-column epp-col-general">
                  <div className="epp-item">
                    ...
                    <div className="epp-data">
                      ...
                      <strong className="epp-value">
                        {formatDate(patient?.fecha_nacimiento) || "12 mar 1998"}
                        {ageText}
                      </strong>
                    </div>
                  </div>
                ...
                <div className="epp-column epp-col-middle">
                  ...
                  <div className="epp-sub-section">
                    ...
                    <div className="epp-row">
                      ...
                      <span className="epp-stat epp-normal">
                        <span className="epp-dot epp-dot-green"></span>Normal
                      </span>
                    </div>
                    <div className="epp-row">
                      <span className="epp-prop">Neuropatía</span>
                      <span className="epp-stat epp-neutral">
                        <span className="epp-dot epp-dot-gray"></span>No
                        evaluado
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="epp-sub-section">
                    <div className="epp-header">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={1.5}
                          d="M12 21c-5-5-5-10-5-10V5h10v6s0 5-5 10z"
                        />
                      </svg>
                    ...
                    <div className="epp-row">
                      ...
                      <strong className="epp-stat-val">
                        92 <span className="epp-unit">mL/min/1.73m²</span>
                      </strong>
                    </div>
                    <div className="epp-row">
                      <span className="epp-prop">Albúmina en orina</span>
                      <strong className="epp-stat-val">
                        12 <span className="epp-unit">mg/g</span>
                      </strong>
                    </div>
                  </div>
                </div>
                ...
                <div className="epp-column epp-col-right">
                  ...
                  <div className="epp-sub-section">
                    ...
                    <div className="epp-row">
                      ...
                      <strong className="epp-stat-val">
                        22 <span className="epp-unit">U/L</span>
                      </strong>
                    </div>
                    <div className="epp-row">
                      <span className="epp-prop">AST</span>
                      <strong className="epp-stat-val">
                        19 <span className="epp-unit">U/L</span>
                      </strong>
                    </div>
                  </div>
          ...
          <div className="banner-stats">
            ...
            <div className="banner-stat-item">
              ...
              <div className="banner-stat-content">
                ...
                <span className="banner-stat-subtitle">
                  Promedio {avgReadingsPerDay}/día
                </span>
              </div>
            </div>
        ...
        {prefs.glucosa ? (
          <>
                              ...
                              {cv !== null && cv > 36 && (
                                <div className="metric-info-box">
                                  ...
                                  <div>
                                    ...
                                    <p>
                                      La variabilidad por encima del objetivo
                                      aumenta el riesgo de eventos de hipo e
                                      hiperglucemia.
                                    </p>
                                  </div>
                                </div>
                        ...
                        <div className="subcard-inner">
                          ...
                          <div style={{ marginTop: "16px" }}>
                            <div className="event-card-item">
                              ...
                              <div
                                className={`event-card-count ${
                                  fusion?.glucose?.eventos?.hiper_severa > 0
                                    ? "red"
                                    : ""
                                }`}
                              >
                            ...
                            <div className="event-card-item">
                              ...
                              <div
                                className={`event-card-count ${
                                  fusion?.glucose?.eventos?.hipo_severa > 0
                                    ? "red"
                                    : ""
                                }`}
                              >
              ...
              {prefs.hba1c && (
                <div className="card">
                  ...
                  >
                    {!showHistory ? (
                      <HbA1cChart
                        data={hba1cHistory.slice(-4)}
                        targetValue={hba1cTarget}
                      />
                    ) : (
            ...
            {(prefs.grafica_glucosa ||
              (prefs.glucosa && sheetLevel !== "collapsed")) && (
                      ...
                      <>
                        ...
                        <div className="glucose-legend">
                          ...
                          <div className="legend-group">
                            ...
                            <div
                              className={`legend-item ${
                                !activeEventFilters.hipo_severa
                                  ? "disabled"
                                  : ""
                              }`}
                            ...
                            <div
                              className={`legend-item ${
                                !activeEventFilters.hiper_severa
                                  ? "disabled"
                                  : ""
                              }`}
            ...
            >
              {prefs.insulina && (
                <TreatmentCard
                  fusion={fusion}
                  onOpenDrawer={() => setShowTreatmentDrawer(true)}
                />
              )}
              {prefs.ingesta && (
                <div className="card">
                  ...
                  <p className="kpi-big">
                    {avgKcalPerDay
                      ? `${avgKcalPerDay.toFixed(0)} kcal/día`
                      : "—"}
                  </p>
              ...
              {prefs.sueno && (
                <div className="card">
                  ...
                  <p className="kpi-big">
                    {sleepAvgHours
                      ? `${sleepAvgHours.toFixed(1)} h/noche`
                      : "—"}
                  </p>
              ...
              {prefs.eventos &&
                showEventDetails &&
                fusion?.glucose?.event_summary && (
                  <div
                    className="card events-expanded"
                    style={{ flex: "0 0 100%", order: 9 }}
                  >
                    <div className="sheet-header">
                    ...
                    <div className="events-grid">
                      <div className="event-block">
                        ...
                        <p>
                          Total:{" "}
                          {formatMinutes(
                            fusion.glucose.event_summary.hiper_severa
                              .total_minutes
                          )}
                        </p>
                        <p>
                      ...
                      <div className="event-block">
                        ...
                        <p>
                          Promedio:{" "}
                          {fusion.glucose.event_summary.hipo.avg_minutes} min
                        </p>
                        <p>
                          Máximo:{" "}
                          {formatMinutes(
      ...
      <SideDrawer
        open={showHbA1cDrawer}
        title="Hemoglobina glucosilada (HbA1c)"
        onClose={() => setShowHbA1cDrawer(false)}
      >
        <HbA1cDrawerContent
          patientId={pacienteId}
          patient={patient}
          latestHbA1cEvent={latestHbA1cEvent}
          hba1cTarget={hba1cTarget}
          reloadManualEvents={reloadManualEvents}
          onClose={() => setShowHbA1cDrawer(false)}
        />
      </SideDrawer>
      ...
      <SideDrawer
        open={showTreatmentDrawer}
        title="Tratamiento establecido"
        onClose={() => setShowTreatmentDrawer(false)}
      >
        <TreatmentDrawerContent treatment={fusion?.insulin?.treatment} />
      </SideDrawer>
    </div>
  );
}
